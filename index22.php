...
<div id="templatemo_header_wrapper">
	<div id="templatemo_header">
        <div id="site_title">
            <a href="#"><img src="images/templatemo_logo.png" alt="logo" /><span>Free CSS Templates</span></a>
    ...
    <div id="templatemo_content">
    	<div id="templatemo_main_content">
        	...
        	<div class="content_box">
                <h1>Welcome to Liquid Website</h1>
                <div class="image_wrapper image_fl"><img src="images/templatemo_image_01.jpg" alt="image" /></div>
              
              <p align="justify"><em>Pellentesque rutrum est non pede. Mauris varius risus fermentum nulla. Mauris vel sapien mattis urna luctus ultrices. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus tincidunt vehicula est. Vestibulum purus. In hac habitasse platea dictumst.</em></p>
                <p align="justify">Free CSS Template is provided by <a href="#">templatemo</a> for everyone. You may download, edit and apply this template for your websites. Credit goes to <a href="http://www.photovaco.com" target="_blank">Free Photos</a> for photos.   Mauris vel sapien mattis urna luctus ultrices. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. <a href="#">Vivamus tincidunt</a> vehicula est. Vestibulum purus. In hac habitasse platea dictumst.   Aenean eleifend, neque hendrerit elementum sodales, odio erat sagittis quam, sed tempor orci magna vitae tellus.</p>
                <div class="btn_more"><a href="#"><span>+</span> Read More</a></div>
			</div>
            
            <div class="content_box last_box">
            	<h2>New Website Templates</h2>
                <p align="justify">Vivamus vulputate felis. Etiam luctus. Quisque facilisis suscipit elit. Curabitur eleifend congue leo. Donec a purus vel purus sollicitudin placerat. Nunc at sem. Sed pellentesque placerat augue. Mauris pede nisl, placerat nec, lobortis vitae, dictum sed, neque.</p>
                <ul class="tmo_list">
                    <li>Fusce quis diam sit amet tortor luctus pellentesque</li>
                    <li>Donec lectus enim, iaculis in sodales eu, facilisis non ipsum</li>
                    <li> Suspendisse at pede vel lorem pulvinar laoreet</li>
                    <li> Nunc commodo, magna pharetra semper vehicula, dui ligula feugiat elit</li>
                    <li>Praesent orci augue, ultricies aliquam suscipit at, ullamcorper</li>
                    <li>Donec gravida justo sit amet arcu luctus id viverra metus tempus</li>
                </ul>
                <div class="btn_more"><a href="#"><span>+</span> Read More</a></div>
            </div>
